...
# 📊 GitHub Stats:
<div align="center" style="background-color:#0d0d0d; padding:30px; border-radius:20px; display:inline-block; border: 4px solid #00ffff; 
  box-shadow: 0 0 20px #00ffff, 0 0 40px #ff00ff, 0 0 60px #00ff00; animation: glow 2s infinite alternate;">

  <h2 style="color:#00ffff; font-family:monospace; text-shadow: 0 0 10px #00ffff;">🎮 My GitHub Game Stats</h2>

  <img src="https://github-readme-stats.vercel.app/api?username=irfangalib&theme=dark&hide_border=true&count_private=false" 
       style="border-radius:15px; margin:15px 0; border: 2px solid #ff00ff; box-shadow: 0 0 15px #ff00ff;" /><br/>

  <img src="https://nirzak-streak-stats.vercel.app/?user=irfangalib&theme=dark&hide_border=true" 
       style="border-radius:15px; margin:15px 0; border: 2px solid #00ff00; box-shadow: 0 0 15px #00ff00;" /><br/>

  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=irfangalib&theme=dark&hide_border=true&layout=compact" 
       style="border-radius:15px; margin:15px 0; border: 2px solid #ff00ff; box-shadow: 0 0 15px #ff00ff;" />

</div>

<style>
@keyframes glow {
  0% { box-shadow: 0 0 20px #00ffff, 0 0 40px #ff00ff, 0 0 60px #00ff00; }
  50% { box-shadow: 0 0 30px #ff00ff, 0 0 50px #00ffff, 0 0 70px #ff00ff; }
  100% { box-shadow: 0 0 20px #00ff00, 0 0 40px #ff00ff, 0 0 60px #00ffff; }
}
</style>
